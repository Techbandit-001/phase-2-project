  ...
  const handleChange = (e) => {
    ...
    return raphael-recipeform
      ...
      <div className="flex gap-6 p-6">
        <form className="border p-2 rounded-xl w-full bg-amber-100" action="">
          <div>
            <label htmlFor="title">Title</label>
            <input
              id="title"
          ...
          <div className="mt-4">
            <button className="border rounded-lg w-full p-2 bg-amber-500 hover:bg-gray-600">
              Add recipes
            </button>
          </div>
        </form>
